const SearchBar = () => {
    return (
        <form>
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg 
    ...
    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
        ...
        dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Buscar</button>
            </div>
        </form>
    )
}
