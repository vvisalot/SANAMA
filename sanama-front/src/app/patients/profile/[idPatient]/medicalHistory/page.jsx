		...
		<section className="p-4 md:p-14 h-screen">
			...
			<div className="bg-white p-4 rounded shadow-md mb-6">
				...
				<div className="bg-white p-4 rounded shadow-md">
					<h2 className="text-xl font-bold mb-4 border-b pb-2">Hojas Medicas Existentes:</h2>
					...
					<MedicalRecordsTable data={hojasMedicas} options={options} loadingTable={loadingTable} />
				</div>
			</div>
		</section>
	)
