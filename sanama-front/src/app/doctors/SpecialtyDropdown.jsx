...
const SpecialtyDropdown = () => {
    ...
    const fetchSpecialty = async (filtro) => {
        try {
            const data = await doctorService.listarEspecialidades()
            setSpecialtyDropdown(specialtyDropdown)
        } catch (error) {
            console.log("No se pudo obtener las especialidades")
        }
    }
        ...
        <div>
            ...
            <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                    <li>
                        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">dsadsadas</a>
                    </li>
                    <li>
                        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">asdadas</a>
                    </li>
                    <li>
                        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">dsadasda</a>
                    </li>
                    <li>
