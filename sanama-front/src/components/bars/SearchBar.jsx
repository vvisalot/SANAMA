    ...
    return (
        <div className={`py-2 px-4 ${width}`}>
            < div className="relative" >
                ...
                <input name={name} id={name} type="search" className="block w-full p-4 pl-10     text-sm text-gray-900 border border-gray-300 rounded-lg  bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " />
