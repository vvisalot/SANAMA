...
const PatientForm = ({ formComplete, setFormComplete, setPatientId, patientForm, fechaNacimiento, setFechaNacimiento, sexo, setSexo, setPatientForm }) => {
    ...
    const handleRegister = () => {
        ...
        if (isFormFilled && !window.confirm('¿Está seguro de que desea limpiar el formulario? Los datos actuales se perderán.')) {
            return
        }
    ...
    return (
        <section id='section1'>
            <div className="pb-8 flex justify-between items-center">
                ...
                <div>
                    ...
                    <button
                        ...
                        ${isFormEnabled ? 'bg-gray-400 cursor-not-allowed' : 'bg-green-500 hover:bg-green-600'} focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-l w-full sm:w-auto px-5 py-3 text-center ${isFormEnabled ? 'text-gray-700' : ''}`}
                    >Buscar paciente
                    </button>
                </div>

                <SearchPatientModal show={showModal} onClose={handleCloseModal} onSelect={handlePatientSelect} />
            </div>
            ...
            <div className="flex flex-row-reverse">
                <button
                    type="button"
                    className=" m-2 text-white bg-orange-400 hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-l w-full sm:w-auto px-5 py-3 text-center"
                    onClick={modifyOrClearForm}
                >
                    Modificar datos del paciente
                </button>
                {/* <button
                    type="submit"
                    className=" m-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-l w-full sm:w-auto px-5 py-3 text-center"
