...
public class OrdenLaboratorioController {
    ...
    @PostMapping(consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
            MediaType.APPLICATION_JSON_VALUE }, value = "/post/listarOrdenLaboratorioFiltro")
    @ResponseBody
        ...
        try {
            ...
            if (arregloEstados != null) {
                for (Object estadoObjetc : arregloEstados) {
                    ...
                    if (pn_estado.get("estado") == null)
                        estado = null;
                    else
                        estado = pn_estado.get("estado").toString();
                    flag = false;
                    estados.add(estado);
                }
            }
    ...
    @PostMapping(consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
            MediaType.APPLICATION_JSON_VALUE }, value = "/post/buscarOrdenLaboratorio")
    @ResponseBody
    ...
    @PostMapping(consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
            MediaType.APPLICATION_JSON_VALUE }, value = "/post/atenderOrdenLaboratorioV1")
    @ResponseBody
    ...
    @PostMapping(consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
            MediaType.APPLICATION_JSON_VALUE }, value = "/post/registrarOrdenLaboratorio")
    @ResponseBody
